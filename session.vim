...
wincmd w
argglobal
if bufexists(fnamemodify("ftp_data.c", ":p")) | buffer ftp_data.c | else | edit ftp_data.c | endif
balt ftp_data.h
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
wincmd w
argglobal
if bufexists(fnamemodify("reply_process.c", ":p")) | buffer reply_process.c | else | edit reply_process.c | endif
balt reply_process.h
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists(fnamemodify("ftpcommands.c", ":p")) | buffer ftpcommands.c | else | edit ftpcommands.c | endif
balt ftpcommands.h
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
wincmd w
argglobal
if bufexists(fnamemodify("check.c", ":p")) | buffer check.c | else | edit check.c | endif
balt check.h
setlocal keymap=
setlocal noarabic
setlocal autoindent
